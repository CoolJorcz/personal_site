...
#
# See http://www.rubyinside.com/ruby-technician-revealed-autoload-1652.html
#
...
# WE need to respect that if we want our Sinatra apps to run on Heroku without modifcation
